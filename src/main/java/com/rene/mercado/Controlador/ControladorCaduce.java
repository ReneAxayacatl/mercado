...
public class ControladorCaduce {
    ...
    public ModelAndView listar() {
        ...
        ModelAndView mav = new ModelAndView("caduce/lista");

        mav.addObject("caduce",
    ...
    public ModelAndView nuevo() {
        ...
        ModelAndView mav = new ModelAndView("caduce/formulario");

        mav.addObject("caduce", new Caduce());
    ...
    @PostMapping("/guardar")
    public String guardar(@NonNull @ModelAttribute Caduce c) {

        caduceService.guardarCaduce(c);

        return "redirect:/caduce";
